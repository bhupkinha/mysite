...
<html lang="en">
    <head>
        ...
        <link href="<?php echo $path; ?>admin/css/morris.css" rel="stylesheet">
        <link href="<?php echo $path; ?>admin/css/timeline.css" rel="stylesheet">
...
<!--                            <li><a href="#"><i class="fa fa-user fa-fw"></i> User Profile</a>
       ...
       <script src="<?php echo $path; ?>admin/js/bootstrap.min.js"></script>
        ...
        <script src="<?php echo $path; ?>admin/js/raphael.min.js"></script>
        <script src="<?php echo $path; ?>admin/js/morris.min.js"></script>
        <script src="<?php echo $path; ?>admin/js/morris-data.js"></script>
