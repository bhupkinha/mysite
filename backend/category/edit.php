...
<!--                            <li><a href="#"><i class="fa fa-user fa-fw"></i> User Profile</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                       <form name="addCategoryForm" id="addCategoryForm" method="post" class="form-horizontal" enctype="multipart/form-data" action="category.php" >
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input id="name" type="text" class="form-control" name="name" placeholder="Project Type" required="true" value="<?php echo $categorys[0]['name']; ?>">                                        
                                      ...
                                      <div class="col-lg-6">
                                        <div class="form-group">
                                                <label>Title</label>
                                                <input type="text"  name="title" id="title" class="form-control" required="true" value="<?php echo $categorys[0]['title']; ?>">
                                            </div>
                                            </div>
                                            </div>
                                      <div class="col-lg-12">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="descriptions" id="descriptions" required="true"><?php echo $categorys[0]['descriptions']; ?></textarea>
                                            </div>
                                            </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                              <img src="http://<?php echo $path.'/upload/'.$categorys[0]['images']; ?>" alt="Smiley face" height="42" width="42"> 
                                               <input type="text"  name="imageedit" id="imageedit" class="form-control" value="<?php echo $categorys[0]['images']; ?>" style="display: none;">
                                            </div>
                                            </div>
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                                <label>Content</label>
                                                <textarea class="form-control" name="content" id="content"  ><?php echo $categorys[0]['content']; ?></textarea>
                                            </div>
                                         </div>
                                         <div class="col-lg-12">
                                    <div class="col-lg-6">
 ...
 <select name="status" id="status" class="select" style="width: 180px;padding:5px"> <option value="">Select status</option>
                 <option value="1" <?php if($categorys[0]['status'] ==1){echo "selected";} ?>>Active</option>
                <option value="0" <?php if($categorys[0]['status'] ==0){echo "selected";} ?>>Inactive</option>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                              <label>Meta Title</label>
                                                <input type="text"  name="meta_title" id="meta_title" class="form-control" value="<?php echo $categorys[0]['meta_title']; ?>" >
                                            </div>
                                            </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Meta Keyword</label>
                                                <input type="text"  name="meta_keyword" id="meta_keyword" class="form-control" value="<?php echo $categorys[0]['meta_keyword']; ?>" >
                                            </div>
                                            </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                              <label>Meta Description</label>
                                                <input type="text"  name="meta_descriptions" id="meta_descriptions" class="form-control" value="<?php echo $categorys[0]['meta_descriptions']; ?>">
                                            </div>
                                            </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                         ...
                                         <input type="text"  name="edit_id" id="edit_id" class="form-control" value="<?php echo $categorys[0]['id']; ?>" style="display: none;">
