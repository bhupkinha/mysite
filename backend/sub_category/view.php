...
if($_SERVER['HTTP_HOST'] == "localhost"){
    ...
    //echo "<pre>";
    //print_r($sub_categorys);
    //echo $sub_categorys[0]['name'];
   // die;
         $category_id = $sub_categorys[0]['category_id'];
       echo  $sql = "SELECT id,name FROM category where status !=2 AND id=$category_id";
    $result = mysqli_query($conn, $sql);
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                            <div class="form-group">
                                                <label>Name</label>
                                                <p class="help-block"><?php echo $sub_categorys[0]['name']; ?> </p>      
                                            </div>
                                            </div>
                                      ...
                                      <div class="col-lg-6">
                                        <div class="form-group">
                                                <label>Title</label>
                                               <p class="help-block"><?php echo $sub_categorys[0]['title']; ?></p>
                                            </div>
                                            </div>
                                            </div>
                                      <div class="col-lg-12">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                                ...
                                                <p class="help-block"><?php echo $sub_categorys[0]['descriptions']; ?></p>
                                            </div>
                                            </div>
                                    <div class="col-lg-6">
                                            <div class="form-group">
                                              <img src="<?php echo $path.'admin/upload/'.$sub_categorys[0]['images']; ?>" alt="Smiley face" height="100" width="100"> 
                                            </div>
                                            </div>
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                                <label>Content</label>
                                                <p class="help-block"><?php echo $sub_categorys[0]['content']; ?></p>
                                            </div>
                                         </div>
                                         <div class="col-lg-12">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                       <p class="help-block">
                       	<?php if($sub_categorys[0]['status'] ==1){
                       		       echo "Active";
                       		   }else{
                       		   	echo "Inactive";
                       		   } ?>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                              <label>Meta Title</label>
                                                 <p class="help-block">
                                                 	<?php echo $sub_categorys[0]['meta_title']; ?>
                                                 </p>
                                            </div>
                                            </div>
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Meta Keyword</label>
                                                 <p class="help-block"><?php echo $sub_categorys[0]['meta_keyword']; ?> </p>
                                            </div>
                                            </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                              <label>Meta Description</label>
                                                  <p class="help-block">
                                                  	<?php echo $sub_categorys[0]['meta_descriptions']; ?>
                                                  </p>
                                            </div>
                                            </div>
                                            </div>
