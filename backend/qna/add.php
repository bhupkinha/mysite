...
<!--                            <li><a href="#"><i class="fa fa-user fa-fw"></i> User Profile</a>
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Qna Add</h1>
 ...
 <select name="sub_category_id" id="sub_category_id" class="select" style="width: 180px;padding:5px"> <option value="">Select sub Category</option>
