...
if($_SERVER['HTTP_HOST'] == "localhost"){
    ...
    $sql = "SELECT * FROM qna where status !=2 order by id desc limit 10";
    ...
    $sql = "SELECT id,name FROM sub_category where status !=2 order by id desc";
    $result = mysqli_query($conn, $sql);
    ...
    foreach ($sub_categorys as $key => $value) {
            ...
            $subCategoryName[$sub_category_id] = $sub_category_name;
    }
?>
<html lang="en">
    <head>
...
<!--                            <li><a href="#"><i class="fa fa-user fa-fw"></i> User Profile</a>
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-6">
                        <h1 class="page-header">Qna Views</h1>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            if(isset($qnas)){
                                             foreach($qnas as $qna){
                                                //print_r($qna);
                                                ?>
                                            <tr class="odd gradeX" id="qna<?php echo $qna['id'];?>">
                                                  <td><?php
                                                ...
                                                echo $categoryName[$category_id];
                                                  ...
                                                  ?></td>
                                                   <td><?php
                                                  $sub_category_id = $qna['sub_category_id']; 
                                                echo $subCategoryName[$sub_category_id];

                                                  ?></td>
                                                <td><?= $qna['name']; ?></td>
                                                <td><?php echo $qna['name']; ?></td>
                                                <td><?php 
                                                $status = ['1'=>'Active', '0'=>'Inactive']; 
                                                 $statusc = $qna['status']; 
                                                echo $status[$statusc]; ?></td>
                                                <td><a  href="edit.php?id=<?php echo $qna['id']; ?>">Edit</a> |
				<span data-toggle="tooltip" data-placement="top" title="delete" onClick="deleteQna(<?php echo $qna['id']; ?>)">Delete</span>|<a  href="view.php?id=<?php echo $qna['id']; ?>">view</a> 
           </td>
